               ...
               <div class="row">
                  ...
                  <div class="col-md-4">
                     ...
                     <div class="card mb-4 box-shadow">
                        <img class="card-img-top" data-src="holder.js/100px225?theme=thumb&bg=55595c&fg=eceeef&text=Thumbnail" src="{{url('public/uploads/images/'.$detail->image)}}"  width="300" 
                           height="300" alt="Card image ">
                        <!-- <img src="{{ url ('public/uploads/images/pexels-lilartsy-1721092.jpg') }}" alt=""> -->
                        <div class="card-body">
                        <!-- <p class="card-text">{{$detail->id}}</p> -->
                           <p class="card-text">{{$detail->title}}</p>
                           <p class="card-text">{{$detail->excerpt}}</p>
                           
                           <p class="card-text">{{$detail->content}}</p>
                           <div class="btn-group">
                               <button type="button" class="btn btn-sm btn-outline-secondary"><a href="delete_record/{{$detail->id}}"  style="color: gray; text-decoration: none; " 
        onmouseover="this.style.color='white';" 
        onmouseout="this.style.color='gray';">Remove</a></button>
                              <button type="button" class="btn btn-sm btn-outline-secondary"><a href="edit_record/{{$detail->id}}" style="color: gray; text-decoration: none; " 
        onmouseover="this.style.color='white';" 
